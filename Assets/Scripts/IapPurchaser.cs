...
public sealed class IapPurchaser : IStoreListener
{
    private static IapPurchaser instance;

    public static IapPurchaser Instance
    {
        get { return instance ?? (instance = new IapPurchaser()); }
    }
    ...
    {
        Debug.Log("UnityIAP OnInitialized: PASS");
    ...
    {
        Debug.Log("OnInitializeFailed InitializationFailureReason:" + InError);
    ...
    {
        Debug.Log(string.Format("OnPurchaseFailed: FAIL. Product: '{0}', PurchaseFailureReason: {1}", InProduct.definition.storeSpecificId, InReason));
    ...
    {
        Debug.LogError(string.Format("definition = {0},\nmetadata={1}\navailableToPurchase={2},\ntransactionID={3},\nhasReceipt={4}\nreceipt={5}",
        ...
        Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", InArgs.purchasedProduct.definition.id));
        ...
        {
            Debug.Log(string.Format("ProcessPurchase: Restore. Product: '{0}'", InArgs.purchasedProduct.definition.id));
        }
